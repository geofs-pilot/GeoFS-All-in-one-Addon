...
// @grant        GM_addStyle
// ==/UserScript==
let pushToTalk = 'voice'; //Use this to set which version of the AI ATC addon you want. 'text' opens the text ATC box when the PTT key is pressed, and 'voice' allows you to transmit a voice message when the PTT key is pressed.
function ai () {
